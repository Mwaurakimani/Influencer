        ...
        <div class="card-header">
            <div class="icon-holder">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 762 762" fill="none" shape-rendering="auto" width="512"
                    height="512">
                    <desc>"Adventurer" by "Lisa Wischofsky", licensed under "CC BY 4.0". / Remix of the original. - Created
                        with
                        dicebear.com</desc>
                    <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#"
                        xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
                        <rdf:RDF>
                            <cc:Work>
                                <dc:title>Adventurer</dc:title>
                                <dc:creator>
                                    <cc:Agent rdf:about="https://www.instagram.com/lischi_art/">
                                        <dc:title>Lisa Wischofsky</dc:title>
                                    </cc:Agent>
                                </dc:creator>
                                <dc:source>https://www.figma.com/community/file/1184595184137881796</dc:source>
