...
<template>
    <div>
        ...
        <ul>
            <li v-for="agent in  props.Withdrawal.agents" @click.prevent="selectAgent(agent.name)" class=" w-[95%] md:w-[340px] bg-white  sm:m-[auto] md:m-[0px] mb-[20px] card-shadowed">
                <div class="user-icon">
                    <p>{{ agent.name[0] }}</p>
                </div>
                <section>
